...
function font.draw_text(text, x, y, anchor, font_type)
    anchor = anchor or font.anchor.top_left
    font_type = font_type or font.tiny
    ...
    if
        anchor == font.anchor.top_center
        or anchor == font.anchor.center
        or anchor == font.anchor.bottom_center
    then
        draw_x = x - text_width / 2
    elseif
        anchor == font.anchor.top_right
        or anchor == font.anchor.center_right
        or anchor == font.anchor.bottom_right
    then
        draw_x = x - text_width
    end
    ...
    -- Vertical alignment
    if
        anchor == font.anchor.center_left
        or anchor == font.anchor.center
        or anchor == font.anchor.center_right
    then
        draw_y = y - text_height / 2
    elseif
        anchor == font.anchor.bottom_left
        or anchor == font.anchor.bottom_center
        or anchor == font.anchor.bottom_right
    then
